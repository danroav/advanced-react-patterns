...
Context functions are used to abstract functionality the consumer will have to implement explicitly otherwise, it avoid the consumer to direct call implementation details.
## Background
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=01%3A%20Context%20Module%20Functions&em=a.b%40c).
