...
Alias props are declared with the name of the property expected followed by the alias that will be used from then on

useEffect can be used to display warnings

props can be exposed to the client through parameters that handle default behavior to invert dependencies.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=06%3A%20Control%20Props&em=a.b%40c).
