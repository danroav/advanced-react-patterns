...
reducers can be passed as arguments to compound components so the client can inject custom behavior on state change

getProps functions can be used to customize default properties values requested from compound components to the clients needs.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=05%3A%20State%20Reducer&em=a.b%40c).
